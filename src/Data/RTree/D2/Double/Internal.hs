...
module Data.RTree.D2.Double.Internal
  ( MBR (UnsafeMBR, MBR)
  , validMBR
  , eqMBR
  , unionMBR
  ...
  , Data.RTree.D2.Double.Internal.size
...
-- | Uses 'Data.RTree.D2.Double.Internal.map'.
instance Functor RTree where
  fmap = Data.RTree.D2.Double.Internal.map

instance Foldable RTree where
  foldl = Data.RTree.D2.Double.Internal.foldl

  foldr = Data.RTree.D2.Double.Internal.foldr

  foldMap = Data.RTree.D2.Double.Internal.foldMap

  foldl' = Data.RTree.D2.Double.Internal.foldl'

  foldr' = Data.RTree.D2.Double.Internal.foldr'

  null = Data.RTree.D2.Double.Internal.null

  length = size


instance Traversable RTree where
  traverse = Data.RTree.D2.Double.Internal.traverse
...
insertGutRootNode bx x depth n =
  case n of
    ...
    _ -> assert False
           (errorWithoutStackTrace "Data.RTree.D2.Double.Internal.insertGutRootNode: reached a leaf")
                 n
  ...
  where
    go depth bn n =
      case n of
        ...
        _ -> assert False
               (errorWithoutStackTrace "Data.RTree.D2.Double.Internal.insertGutNode: reached a leaf")
               n
  ...
  where
    go height bn n =
      case n of
        ...
        _ -> assert False
               (errorWithoutStackTrace "Data.RTree.D2.Double.Internal.insertNode: reached a leaf")
               n
  ...
  where
    ...
    compress [] =
      errorWithoutStackTrace
        "Data.RTree.D2.Double.Internal.bulkSTR: zero-sized partition"
    ...
    base as =
      case as of
        ...
        _ -> errorWithoutStackTrace
               "Data.RTree.D2.Double.Internal.bulkSTR: malformed leaf"
